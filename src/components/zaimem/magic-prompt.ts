...
3. DURING THE SESSION → call zaimem_remember for every durable fact, decision, preference or reflection I reveal (one fact per call). Auto-dedupe is built in, don't worry about duplicates.
